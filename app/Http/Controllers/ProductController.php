...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $this->validate($request, ["name" => "required", "price" => "required", 'brand_id' => 'required|not_in:0', 'category_id' => 'required|not_in:0', 'child' => 'not_in:0',
        ...
        if (isset($request->tax_manual)) {
            ...
            $request->validate(['tax_r' => 'numeric', 'tax_name' => 'string|min:1']);
        ...
        if ($request->return_avbls == "1") {
            ...
            $request->validate(['return_avbls' =>  'return_policy' ], ['return_policy' => 'Please choose return policy']);
