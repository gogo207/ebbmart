...
class DiscoveryController extends Controller
{
    ...
    public function index()
    {
        ...
        //  $discoverys = DiscoveryEnquiry::all();
        // var_dump($discoverys);
        // return view("admin.discovery.index",compact("discoverys"));
    }
    ...
    {
         $discoverys = DiscoveryEnquiry::find($request->id);
    
        return view("admin.discovery.view",compact("discoverys"));
    }
