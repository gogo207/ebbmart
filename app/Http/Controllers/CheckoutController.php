...
class CheckoutController extends Controller
{
     ...
     public function foodvendor()
    {
        ...
        require_once 'price.php';
        $user = Auth::user();
        return view('user.foodvendor', compact('user','country', 'conversion_rate'));
    }
     ...
     public function add_food(Request $request)
    {
        ...
        $request->validate([
            ...
            $ext=$image->extension();
            $file=time().'.'.$ext;
            $image->storeAs('/public/vendor/food',$file);
            $data=array(
                ...
                'image'=>$file,
                'description_restaurant'=>$request->input('description'),
                'cuisine'=>$request->input('cuisine'),
            );
            
            DB::table('food_vendor')->insert($data);
