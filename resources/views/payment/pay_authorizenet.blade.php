                                        ...
                                        <form id="payment-card-info" method="post" action="{{ route('dopay.online') }}">
                                            ...
                                            <div class="row">
                                                <div class="form-group owner col-md-8">
                                                    ...
                                                    <input type="text" class="form-control" id="owner" name="owner" value="{{ Auth::user()->name }}" required>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-8" id="card-number-field">
                                                    ...
                                                    <input type="text" class="form-control" id="cardNumber" name="cardNumber" placeholder="4111111111111111" required>
                                                    <span id="card-error" class="error text-red">Please enter valid card number</span>
                                                </div>
                                                <div class="form-group col-md-4" >
                                                    <label for="amount">Amount</label>
                                                    <input type="number" class="form-control" value="{{$amount}}" required disabled>
