...
<body class="cnt-home">
  ...
  @if(count($brands) > 0)
    <div id="brands-carousel" class="logo-slider logo-slider-one" style="background: rgb(0 0 255);">
  ...
  <div>
    ...
    @if($enable_newsletter_widget->home == '1' && isset($enable_newsletter_widget) || $enable_newsletter_widget->shop == "1")
      ...
      <div class="container p-5 newsletter-bg-custom"style="background: rgb(0 0 255);    border-top: 1px solid #fff;">
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="module-body module-small-screen">
              ...
              <!--    @endif-->
              <!--  @endif-->
                <li class="last"><a href="{{url('helpcenter')}}"
              ...
              <!--</li>-->
              <li class="first"><a href="{{url('report-abuse')}}" title="Report Abuse">Report Abuse</a>
              </li>
              <li class="first"><a href="{{url('dispute-form')}}" title="Submit a Dispute">Submit a Dispute</a>
              
              <!--<li class="first"><a href="{{url('show/privacy-policy')}}" title="Policies & Rules">Policies & Rules</a>
              </li>-->
              <li class="first"><a  href="{{url('feedback-form')}}" title="Feedback">Feedback Form</a>
              </li>
              </ul>
            </div>
            <!-- /.module-body -->
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
           ...
           <div class="col-xs-12 col-sm-12 col-md-12 text-right">
              <a class="btn custom-btn" href="{{ url('blog') }}">News & Annoucements</a>
            </div>
        </div>
      </div>
    </div>
    <div class="copyright-bar header-nav-screen">
      <div class="container">
        <div class="row">
          ...
          <!--  </ul>-->
          <!--</div>-->
          <div class="col-xs-12 col-sm-12 col-lg-12 no-padding copyright text-center">
