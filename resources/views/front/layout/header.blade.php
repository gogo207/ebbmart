...
.top-cart-row .dropdown-cart .lnk-cart .items-cart-inner .basket:before {
    ...
    background: url(https://client.growthpartner4u.com/ebobmart/images/icon-cart2.png) no-repeat top left;
   height: 50px;
}
.casual-class {
    padding: 70px 0px;
                ...
                <div class="display-none-block">
                    <ul class="list-unstyled">
                        ...
                        <li class="first"><a target="_blank" title="{{ __('staticwords.SellerDashboard') }}"
                            href="{{ url('seller/myprofile') }}"title="Admin">{{ __('staticwords.SellerDashboard') }}</a>
                        </li>
                        @endif
                        @endif
        ...
        <div class="row">
            <div class="col-6  col-md-2 col-sm-2 col-lg-2 logo-holder">
                ...
                <div class="logo"> <a href="{{url('/')}}" title="{{$title}}"> <img height="50px"
                      src="{{url('images/genral/'.$front_logo)}}" alt="logo" 
                      title="Happy Customers Shop Here™"> <p class="bottom-content-logo" title="Happy Customers Shop Here™">Happy Customers Shop Here™</p></a> </div>
                <!-- /.logo -->
                <!--=================== LOGO : END ================= -->
              </div>
            <!-- /.logo-holder -->
