        ...
        <div class="contact-page">
            <div class="row">
                ...
                <div class="col-md-8 contact-form">
                    <form action="{{ route('get.disputeform') }}" method="POST" novalidate class="form" enctype='multipart/form-data'>
                        @csrf
                    <div class="row">
                       
                        <div class="col-md-12 contact-title">
                            <h4>{{ __('staticwords.DisputeForm') }}</h4>
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label class="info-title" for="share_link">URL<span
                                        class="text-danger">*</span></label>
                                <input  name="share_link"  type="text" required
                                    class="@error('share_link') 'is-invalid' @enderror form-control unicase-form-control text-input"
                                    id="share_link" value="{{ old('share_link') }}"
                                    placeholder="share link if any">
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label class="info-title" for="dispute_reason">{{ __('staticwords.DisputeReason') }}: <span
                                        class="text-danger">*</span></label>
                                <select required name="dispute_reason" 
                                    class=" form-control unicase-form-control text-input">
