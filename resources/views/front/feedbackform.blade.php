        ...
        <div class="contact-page">
            <div class="row">
                ...
                <div class="col-md-8 contact-form">
                    <form action="{{ route('get.feedbackform') }}" method="POST" novalidate class="form" enctype='multipart/form-data'>
                        @csrf
                    <div class="row">
                       
                        <div class="col-md-12 contact-title">
                            <h4>{{ __('staticwords.FeedbackForm') }}</h4>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label class="info-title" for="feedback_about">{{ __('staticwords.FeedbackAbout') }}: <span
                                        class="text-danger">*</span></label>
                                <select required name="feedback_about" 
