  ...
  <aside id="mainSidebar" class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="discovery" class="{{ Nav::isRoute('discovery.index') }}">
          <a class="treeview" href="{{ route('discovery.index') }}">
           <i class="fa fa-life-saver"></i> <span>Discovery</span>

          </a>
        </li>
        
        <li id="discovery" class="{{ Nav::isRoute('contact.view') }}">
          <a class="treeview" href="{{ route('contact.view') }}">
           <i class="fa fa-id-card"></i> <span>Contact</span>
