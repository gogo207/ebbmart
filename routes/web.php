...
Route::group(['middleware' => ['web','switch_lang']], function () {
    ...
    Route::group(['middleware' => ['maintainence_mode']], function () {
        ...
        Route::post('/contact-us','ContactController@getConnect')->name('get.connect');
         ...
         Route::get('/insurance','ContactController@insurance')->name('insurance');

        Route::post('/insurance','ContactController@getInsurance')->name('get.insurance');
        
         Route::get('/report-abuse','ContactController@reportabuse')->name('reportabuse');

        Route::post('/report-abuse','ContactController@getReportabuse')->name('get.reportabuse');
        
         Route::get('/dispute-form','ContactController@disputeform')->name('disputeform');

        Route::post('/dispute-form','ContactController@getDisputeform')->name('get.disputeform');
        
         Route::get('/feedback-form','ContactController@feedbackform')->name('feedbackform');

        Route::post('/feedback-form','ContactController@getFeedbackform')->name('get.feedbackform');
        
         Route::get('/leave-your-comment','ContactController@leaveyourcomment')->name('leaveyourcomment');

        Route::post('/leave-your-comment','ContactController@getLeaveyourcomment')->name('get.leaveyourcomment');
        
        
        
        Route::get('/helpcenter','ContactController@helpcenter')->name('helpcenter');
        Route::get('/thankyou','ContactController@thankyou')->name('thankyou');
         Route::get('/learning-center','ContactController@learningcenter')->name('learningcenter');
           Route::get('/resources','ContactController@resources')->name('resources');
        ...
        Route::group(['middleware' => ['IsInstalled', 'is_verified', 'isActive', 'two_fa','switch_lang']], function () {
            ...
            /*
            route for payment authorize.net
                Pradeep
            */
                Route::post('/pay/via/authorization/','PaymentController@pay_authorizenet')->name('pay.viaauthorization');
                Route::post('/dopay/online/', 'PaymentController@handleonlinepay')->name('dopay.online');
                Route::get('response/authorizenet/','PaymentController@response_authorizenet')->name('response.authorizenet');
        ...
        Route::group(['middleware' => ['auth','is_verified','two_fa','switch_lang']], function () {
            ...
            Route::get('foodvendor', 'CheckoutController@foodvendor')->name('foodvendor');
            Route::post('/food_add', 'CheckoutController@add_food');
            ...
            /*Seller Routes start*/
            // Route::get("sellerfoodvendor", "VenderController@foodvendor")->name('seller.foodvendor');
   ...
   // Route::group(['middleware' => ['isActive', 'IsInstalled', 'switch_lang', 'is_admin', 'auth']], function () {
    Route::group(['middleware' => ['isActive', 'switch_lang', 'is_admin', 'auth']], function () {
        ...
        Route::get('admin/discovery', 'DiscoveryController@index')->name('discovery.index');
        Route::get('admin/discovery/show/{id}', 'DiscoveryController@show')->name('discovery.show');
        
        Route::get('admin/contact-form', 'ContactController@view')->name('contact.view');
        Route::get('admin/contact/delete/{id}', 'ContactController@destroy')->name('contact.destroy');
